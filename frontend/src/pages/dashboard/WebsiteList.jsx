            ...
            {filteredWebsites.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {item.is_verified ? (
                      <span className="text-[9px] font-black bg-deep-green/5 text-muted-text/70 border border-border-color/60 px-3 py-1.5 rounded-lg select-none cursor-not-allowed uppercase tracking-wider">
                        Audit Coming Soon
                      </span>
                    ) : (
                      <button
