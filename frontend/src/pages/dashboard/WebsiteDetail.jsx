          ...
          <div className="bg-gradient-to-br from-[#0A4B43] to-[#053D34] rounded-3xl p-6 md:p-8 border border-border-color/20 text-white relative overflow-hidden shadow-sm">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="space-y-1">
                <h3 className="text-lg font-black">Website ownership verified successfully.</h3>
                <p className="text-xs text-[#E5F3EC]/85 leading-relaxed max-w-xl font-semibold">
                  This domain has been verified and mapped to your workspace. Technical SEO audits and reports will become available in subsequent versions of the platform.
                </p>
              </div>
              <div className="pt-2">
                <button
                  onClick={() => navigate('/websites')}
                  className="bg-[#36E682] hover:bg-white text-[#053D34] px-5 py-2.5 rounded-xl text-xs font-black transition-all shadow-md cursor-pointer"
                >
                  Return to Websites
                </button>
              </div>
